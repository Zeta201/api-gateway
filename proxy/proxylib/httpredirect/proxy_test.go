...
func (s *HTTPRedirectSuite) TestHTTPRedirectOnDataBasicPass(c *C) {
	...
	s.ins.CheckInsertPolicyText(c, "1", []string{`
		...
		>
		`})
	conn := s.ins.CheckNewConnectionOK(c, "HTTPRedirect", true, 1, 2, "1.1.1.1:34567", "10.0.0.2:80", "1.1.1.1")
...
func (s *HTTPRedirectSuite) TestHTTPRedirectOnDataMultipleReq(c *C) {
	...
	s.ins.CheckInsertPolicyText(c, "1", []string{`
		...
		>
		`})
	conn := s.ins.CheckNewConnectionOK(c, "HTTPRedirect", true, 1, 2, "1.1.1.1:34567", "2.2.2.2:80", "1.1.1.1")
