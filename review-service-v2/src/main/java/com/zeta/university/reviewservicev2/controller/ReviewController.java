package com.zeta.university.reviewservicev2.controller;
...
import com.zeta.university.reviewservicev2.common.ReviewRequest;
import com.zeta.university.reviewservicev2.entity.Review;
import com.zeta.university.reviewservicev2.service.ReviewService;
...
public class ReviewController {
	...
	public Review submitReview(@RequestBody ReviewRequest request) {
		Review newReview = Review.builder().username(request.getUsername())
				.content(request.getContent()).stars(request.getStars()).color("red").build();
